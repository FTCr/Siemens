...
__root const CFG_HDR colhdr0 = {CFG_COLOR, "Header", 0, 0};
__root const char cfg_col_header[4] = {0xFF,0xFF,0xFF,0x64};

__root const CFG_HDR colhdr1 = {CFG_COLOR, "Softkeys", 0, 0};
__root const char cfg_col_softkeys[4] = {0xFF,0xFF,0xFF,0x64};

__root const CFG_HDR colhdr2 = {CFG_COLOR, "Main", 0, 0};
__root const char cfg_col_main[4] = {0x00,0x00,0x00,0x64};

__root const CFG_HDR colhdr3 = {CFG_COLOR, "Menu main", 0, 0};
__root const char cfg_col_menu_main[4] = {0xFF,0xFF,0xFF,0x64};

__root const CFG_HDR colhdr4 = {CFG_COLOR, "Menu main add", 0, 0};
__root const char cfg_col_menu_main_add[4] = {0xFF,0xFF,0xFF,0x4A};

__root const CFG_HDR colhdr5 = {CFG_COLOR, "Menu line", 0, 0};

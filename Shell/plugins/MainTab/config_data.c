...
__CFG_BEGIN(0)
	...
	__root const CFG_HDR cfghdr0_3={CFG_CHECKBOX,"Activate RIGHT_SOFT?",0,0};
	__root const unsigned int cfg_use_rs = 0;

	__root const CFG_HDR cfghdr0_4 = {CFG_STR_WIN1251, "RIGHT_SOFT shortcut", 0, 31};
	__root const char cfg_rs_func[32]="";
	
	__root const CFG_HDR cfghdr0_5={CFG_CHECKBOX,"Activate ENTER_BUTTON?",0,0};
